Ide bagus. Ini adalah kepingan terakhir yang akan menjamin tampilan aplikasi kamu **benar-benar terlihat seperti "System Interface"** (Solo Leveling) dan bukan seperti dashboard admin biasa.

File ini akan memandu OpenCode agar tidak "mengarang bebas" soal CSS dan animasi.

Simpan file ini dengan nama **`frontend-guidance.md`**.
...
**Selesai!** Sekarang kamu punya paket lengkap: Logic, Database, API, Context, Agent Prompt, dan UI Guidance. Hasilnya akan sangat solid.