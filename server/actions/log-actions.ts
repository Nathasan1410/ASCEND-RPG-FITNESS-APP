  ...
  try {
    ...
    await sendTraceToOpik("quest_evaluation_complete", {
      ...
      output: {
        ...
        effort_score: evaluation.effortScore,
        safety_score: evaluation.safetyScore,
        overall_score: (evaluation.integrity_score + evaluation.effortScore + evaluation.safetyScore) / 3,
        ...
        // Add AI Judge evaluation scores
        ai_integrity_score: evaluation.integrity_score || 0,
        ai_effort_score: evaluation.effortScore || 0,
        ai_safety_score: evaluation.safetyScore || 0,
